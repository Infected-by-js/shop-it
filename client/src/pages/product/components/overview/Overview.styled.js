...
import { color, fonts, animationSpeed, device } from '../../../../assets/styles/constants';
...
export const PreviewItem = styled.li`
	...
	transition: opacity ${animationSpeed.fast} ease, border-color ${animationSpeed.fast} ease;
