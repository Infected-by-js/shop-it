...
export const authFadeInUpVariants = {
	initial: { y: 30, opacity: 0, transition: { duration: 0.8, ease: defaultEasing } },
	animate: { y: 0, opacity: 1, transition: { duration: 0.8, ease: defaultEasing } },
};
...
export const posterFadeInVariants = {
	initial: { y: 20, opacity: 0, transition: { duration: 0.5, ease: defaultEasing } },
	animate: { y: 0, opacity: 1, transition: { duration: 0.5, ease: defaultEasing } },
	exit: { y: 20, opacity: 0, transition: { duration: 0.5, ease: defaultEasing } },
};
...
export const creditsFadeInUpVariants = {
	initial: { y: 60, opacity: 0, transition: { duration: 0.8, ease: defaultEasing } },
	animate: { y: 0, opacity: 1, transition: { delay: 0.8, duration: 0.8, ease: defaultEasing } },
	exit: { y: 60, opacity: 0, transition: { duration: 0.8, ease: defaultEasing } },
};
